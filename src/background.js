...
// Handles: AI summarization, skill generation, settings storage, and the
// keyboard shortcut. This service worker is the only context that calls the AI
// providers; a content-script fetch would be blocked by YouTube's CSP.
// Version: 2.0.0
